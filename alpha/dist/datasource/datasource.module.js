...
const datasource_provider_1 = require("./datasource.provider");
let DataSourceModule = class DataSourceModule {
};
DataSourceModule = __decorate([
    (0, common_1.Module)({
        providers: [...datasource_provider_1.datasourceProvider],
        exports: [...datasource_provider_1.datasourceProvider],
    })
], DataSourceModule);
